...
?>
<div class="services">
    <div class="services-heading py-[240px] bg-terracotta text-light-white">
        <div class="container">
            <div class="flex flex-wrap relative">
                <div class="w-full md:w-6/12 relative pr-10">
                    <div class="services__image">
                        <?php if ($attributes["image"]["url"]): ?>
                                <div class="image-wrapper w-7/12 image-reveal" data-scroll data-scroll-speed="-1" data-scroll-delay="0.05">
                                    <img src="<?= $attributes['image']['url'] ?>" alt="<?= $attributes['image']['alt'] ?>">
                                </div>
                        <?php endif; ?>
                    </div>
                </div>
                <div class="w-full md:w-6/12 pl-14 ">
    ...
    <div class="py-[60px]">
        <?php foreach ($attributes['services'] as $service): ?>
            <div class="flex flex-wrap services__item">
                <div class="w-full md:w-6/12 flex items-center services__item--content">
                    <div class="w-10/12">
                        <h4 class="mb-[24px] text-warm-brown"><?= $service['title'] ?></h4>
                        <div class="text-base"><?= $service['description'] ?></div>
                    </div>
                </div>
                <div class="w-full flex md:w-6/12 services__item--image--wrapper">
